...
export async function generateMetadata() {
  ...
  return pageMetadata({ ...maintenance.seo, path: PATH, image: maintenance.hero.image.src });
}

export default async function MaintenancePage() {
  const [maintenance, services] = await Promise.all([getContent("maintenance"), getContent("services")]);
  const crumbs = [
